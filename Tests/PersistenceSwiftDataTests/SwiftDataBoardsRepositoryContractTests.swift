// Tests/PersistenceSwiftDataTests/SwiftDataBoardsRepositoryContractTests.swift
// Contract tests for SwiftData BoardsRepository implementation
...
@testable import PersistenceSwiftData

/// Contract tests for SwiftData BoardsRepository
/// These run the same tests as GRDBBoardsRepository but against SwiftData
@available(macOS 14.0, iOS 17.0, *)
final class SwiftDataBoardsRepositoryContractTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        repository = try SwiftDataBoardsRepository.inMemory()
    }
