// Tests/PersistenceSwiftDataTests/SwiftDataListsRepositoryContractTests.swift
// Contract tests for SwiftData ListsRepository implementation
...
/// Contract tests for SwiftData ListsRepository
/// These run the same tests as GRDBListsRepository but against SwiftData
@available(macOS 14.0, iOS 17.0, *)
final class SwiftDataListsRepositoryContractTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        repository = try SwiftDataListsRepository.inMemory()
    }
