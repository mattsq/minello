// Tests/PersistenceSwiftDataTests/SwiftDataRecipesRepositoryContractTests.swift
// Contract tests for RecipesRepository using SwiftData implementation

import Domain
import Foundation
import PersistenceInterfaces
import PersistenceSwiftData
import XCTest

/// Contract tests for RecipesRepository using SwiftData
/// These tests verify that SwiftDataRecipesRepository meets the RecipesRepository contract
@MainActor
final class SwiftDataRecipesRepositoryContractTests: XCTestCase {
    var repository: RecipesRepository!

    override func setUp() async throws {
        try await super.setUp()
        // Use in-memory SwiftData for testing
        repository = try SwiftDataRecipesRepository.inMemory()
    }
