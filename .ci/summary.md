...
**Run**: [20392709920](https://github.com/mattsq/minello/actions/runs/20392709920)
**Commit**: `d9cccc3f`
**Branch**: `claude/resolve-ci-issues-90fT1`
**PR**: #17
**Time**: 2025-12-20T09:56:48.305573Z
...
error: Build input files cannot be found: '/Users/runner/work/minello/minello/HomeCooked/ContentView.swift', '/Users/runner/work/minello/minello/HomeCooked/HomeCookedApp.swift'. Did you forget to declare these files as outputs of any script phases or custom build rules which produce them? (in target 'HomeCooked' from project 'HomeCooked')
...
/Users/runner/work/minello/minello/HomeCooked/Assets.xcassets: error: None of the input catalogs contained a matching stickers icon set or app icon set named  "AppIcon".
/* com.apple.actool.notices */
/Users/runner/work/minello/minello/HomeCooked/Assets.xcassets: warning: Failed to read file attributes for "/Users/runner/work/minello/minello/HomeCooked/Assets.xcassets"
Testing failed:
None of the input catalogs contained a matching stickers icon set or app icon set named  "AppIcon".
Testing cancelled because the build failed.
** TEST FAILED **
The following build commands failed:
CompileAssetCatalog /Users/runner/work/minello/minello/HomeCooked/DerivedData/Build/Products/Debug-iphonesimulator/HomeCooked.app /Users/runner/work/minello/minello/HomeCooked/Assets.xcassets (in target 'HomeCooked' from project 'HomeCooked')
```
...
- `error: Build input files cannot be found: '/Users/runner/work/minello/minello/HomeCooked/ContentView`
- `SwiftDriver\ Compilation\ Requirements HomeCooked normal x86_64 com.apple.xcode.tools.swift.compiler`
- `builtin-Swift-Compilation-Requirements -- /Applications/Xcode_15.4.app/Contents/Developer/Toolchains`
...
- `};`
- `/* com.apple.actool.errors */`
- `/Users/runner/work/minello/minello/HomeCooked/Assets.xcassets: error: None of the input catalogs con`
- `/* com.apple.actool.notices */`
- `/Users/runner/work/minello/minello/HomeCooked/Assets.xcassets: warning: Failed to read file attribut`
- `Testing failed:`
- `Linting Swift files in current working directory`
- `Error: No lintable files found at paths: ''`
- `Running SwiftFormat...`
...
Full structured results: `.ci/summary.json` in branch `claude/resolve-ci-issues-90fT1`
